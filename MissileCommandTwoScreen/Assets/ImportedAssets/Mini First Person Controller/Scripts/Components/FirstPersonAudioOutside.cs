...
public class FirstPersonAudioOutside : MonoBehaviour
{
    public FirstPersonMovementOutside character;
    ...
    {
        // Setup stuff.
        character = GetComponentInParent<FirstPersonMovementOutside>();
        ...
        // Setup crouch audio.
        crouch = GetComponentInParent<CrouchOutside>();
        if (crouch)
        {
