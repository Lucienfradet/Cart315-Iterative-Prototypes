...
public class FirstPersonAudioInside : MonoBehaviour
{
    public FirstPersonMovementInside character;
    ...
    {
        // Setup stuff.
        character = GetComponentInParent<FirstPersonMovementInside>();
        ...
        // Setup crouch audio.
        crouch = GetComponentInParent<CrouchInside>();
        if (crouch)
        {
